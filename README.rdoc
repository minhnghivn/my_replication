...
development:
    ...
    replicas:
      ...
      - name: replication2
        ...
        host: localhost
==Examples
Use replication block to switch database connection (randomly) to one of the replicated databases (do not connect to the master one) and then execute the statement inside the block
