...
== Examples
Use replication block to switch database connection (randomly) to one of the replicated databases (do not connect to the master one) then execute the statement inside the block
...
== Contact
The author of this plugin can be reached at:
* Email: minhnghivn@yahoo.com
* Y!M: minhnghivn
* Skype: minhnghivn
